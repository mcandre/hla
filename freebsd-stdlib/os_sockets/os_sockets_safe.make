...
sock_bind_safe.o: sock_bind.hla \
	...
	hla -thread -c -p:temp -b:sock_bind_safe  sock_bind
...
sock_cleanup_safe.o: sock_cleanup.hla \
	...
	hla -thread -c -p:temp -b:sock_cleanup_safe  sock_cleanup
...
sock_close_safe.o: sock_close.hla \
	...
	hla -thread -c -p:temp -b:sock_close_safe  sock_close
...
sock_connect_safe.o: sock_connect.hla \
	...
	hla -thread -c -p:temp -b:sock_connect_safe  sock_connect
...
sock_gethostbyaddr_safe.o: sock_gethostbyaddr.hla \
	...
	hla -thread -c -p:temp -b:sock_gethostbyaddr_safe  sock_gethostbyaddr
...
sock_gethostbyname_safe.o: sock_gethostbyname.hla \
	...
	hla -thread -c -p:temp -b:sock_gethostbyname_safe  sock_gethostbyname
...
sock_gethostname_safe.o: sock_gethostname.hla \
	...
	hla -thread -c -p:temp -b:sock_gethostname_safe  sock_gethostname
...
sock_getpeername_safe.o: sock_getpeername.hla \
	...
	hla -thread -c -p:temp -b:sock_getpeername_safe  sock_getpeername
...
sock_getsockname_safe.o: sock_getsockname.hla \
	...
	hla -thread -c -p:temp -b:sock_getsockname_safe  sock_getsockname
...
sock_getsockopt_safe.o: sock_getsockopt.hla \
	...
	hla -thread -c -p:temp -b:sock_getsockopt_safe  sock_getsockopt
...
sock_accept_safe.o: sock_accept.hla \
	...
	hla -thread -c -p:temp -b:sock_accept_safe  sock_accept
...
sock_listen_safe.o: sock_listen.hla \
	...
	hla -thread -c -p:temp -b:sock_listen_safe  sock_listen
...
sock_recv_safe.o: sock_recv.hla \
	...
	hla -thread -c -p:temp -b:sock_recv_safe  sock_recv
...
sock_recvfrom_safe.o: sock_recvfrom.hla \
	...
	hla -thread -c -p:temp -b:sock_recvfrom_safe  sock_recvfrom
...
sock_select_safe.o: sock_select.hla \
	...
	hla -thread -c -p:temp -b:sock_select_safe  sock_select
...
sock_send_safe.o: sock_send.hla \
	...
	hla -thread -c -p:temp -b:sock_send_safe  sock_send
...
sock_sendto_safe.o: sock_sendto.hla \
	...
	hla -thread -c -p:temp -b:sock_sendto_safe  sock_sendto
...
sock_setsockopt_safe.o: sock_setsockopt.hla \
	...
	hla -thread -c -p:temp -b:sock_setsockopt_safe  sock_setsockopt
...
sock_setTimeout_safe.o: sock_setTimeout.hla \
	...
	hla -thread -c -p:temp -b:sock_setTimeout_safe  sock_setTimeout
...
sock_shutdown_safe.o: sock_shutdown.hla \
	...
	hla -thread -c -p:temp -b:sock_shutdown_safe  sock_shutdown
...
sock_socket_safe.o: sock_socket.hla \
	...
	hla -thread -c -p:temp -b:sock_socket_safe  sock_socket
...
sock_init_safe.o: sock_init.hla \
	...
	hla -thread -c -p:temp -b:sock_init_safe  sock_init
