...
mem_alloc2_safe.o: mem_alloc2.hla \
	...
	hla -thread -c -p:temp -b:mem_alloc2_safe  mem_alloc2
...
mem_allocBlockInHeap_safe.o: mem_allocBlockInHeap.hla \
	...
	hla -thread -c -p:temp -b:mem_allocBlockInHeap_safe  mem_allocBlockInHeap
...
mem_blockinheap_safe.o: mem_blockinheap.hla \
	...
	hla -thread -c -p:temp -b:mem_blockinheap_safe  mem_blockinheap
...
mem_free_safe.o: mem_free.hla \
	...
	hla -thread -c -p:temp -b:mem_free_safe  mem_free
...
mem_freeblockinheap_safe.o: mem_freeblockinheap.hla \
	...
	hla -thread -c -p:temp -b:mem_freeblockinheap_safe  mem_freeblockinheap
...
mem_freePtr_safe.o: mem_freePtr.hla \
	...
	hla -thread -c -p:temp -b:mem_freePtr_safe  mem_freePtr
...
mem_getRef_safe.o: mem_getRef.hla \
	...
	hla -thread -c -p:temp -b:mem_getRef_safe  mem_getRef
...
mem_isinheap_safe.o: mem_isinheap.hla \
	...
	hla -thread -c -p:temp -b:mem_isinheap_safe  mem_isinheap
...
mem_newRef_safe.o: mem_newRef.hla \
	...
	hla -thread -c -p:temp -b:mem_newRef_safe  mem_newRef
...
mem_realloc1_safe.o: mem_realloc1.hla \
	...
	hla -thread -c -p:temp -b:mem_realloc1_safe  mem_realloc1
...
mem_realloc2_safe.o: mem_realloc2.hla \
	...
	hla -thread -c -p:temp -b:mem_realloc2_safe  mem_realloc2
...
mem_safeFree_safe.o: mem_safeFree.hla \
	...
	hla -thread -c -p:temp -b:mem_safeFree_safe  mem_safeFree
...
mem_alloc1_safe.o: mem_alloc1.hla \
	...
	hla -thread -c -p:temp -b:mem_alloc1_safe  mem_alloc1
...
mem_stat_safe.o: mem_stat.hla \
	...
	hla -thread -c -p:temp -b:mem_stat_safe  mem_stat
...
mem_stralloc1_safe.o: mem_stralloc1.hla \
	...
	hla -thread -c -p:temp -b:mem_stralloc1_safe  mem_stralloc1
...
mem_stralloc2_safe.o: mem_stralloc2.hla \
	...
	hla -thread -c -p:temp -b:mem_stralloc2_safe  mem_stralloc2
...
mem_strfree_safe.o: mem_strfree.hla \
	...
	hla -thread -c -p:temp -b:mem_strfree_safe  mem_strfree
...
mem_strfreePtr_safe.o: mem_strfreePtr.hla \
	...
	hla -thread -c -p:temp -b:mem_strfreePtr_safe  mem_strfreePtr
...
mem_strgetref_safe.o: mem_strgetref.hla \
	...
	hla -thread -c -p:temp -b:mem_strgetref_safe  mem_strgetref
...
mem_strisinheap_safe.o: mem_strisinheap.hla \
	...
	hla -thread -c -p:temp -b:mem_strisinheap_safe  mem_strisinheap
...
mem_strnewref_safe.o: mem_strnewref.hla \
	...
	hla -thread -c -p:temp -b:mem_strnewref_safe  mem_strnewref
...
mem_strrealloc_safe.o: mem_strrealloc.hla \
	...
	hla -thread -c -p:temp -b:mem_strrealloc_safe  mem_strrealloc
...
mem_strSafeFree_safe.o: mem_strSafeFree.hla \
	...
	hla -thread -c -p:temp -b:mem_strSafeFree_safe  mem_strSafeFree
...
mem_zalloc_safe.o: mem_zalloc.hla \
	...
	hla -thread -c -p:temp -b:mem_zalloc_safe  mem_zalloc
...
mem_size_safe.o: mem_size.hla \
	...
	hla -thread -c -p:temp -b:mem_size_safe  mem_size
